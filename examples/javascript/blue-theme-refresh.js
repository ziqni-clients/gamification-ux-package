(function(){
	...
	widgetInstance.settings.uri.competitionById = "data/competition-data-sample_:id.json";
	widgetInstance.settings.uri.memberCompetitions = "data/competition-list-data-sample.json";
	widgetInstance.settings.uri.memberCompetitionById = "data/competition-data-sample_:competitionId.json";
	...
	widgetInstance.settings.resources = [
		("/build/css/theme/blue-theme-refresh.css?t=" + ( new Date().getTime() ))
	];
